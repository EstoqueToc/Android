    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
                    ...
                    Column(
                        ...
                        Text(
                            ...
                            modifier = Modifier.clickable {
                                navController?.navigate("planos") // Verifica se o navController não é nulo antes de navegar
                            }
                        )
                    }
            ...
            Column(
                ...
                Button(
                    onClick = {
                        // Intent para abrir o link no navegador
                        val url = "https://rasousa555.atlassian.net/servicedesk/customer/portal/1"
